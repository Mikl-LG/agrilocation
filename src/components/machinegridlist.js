...
export default function Machinegridlist({dealerColor,dealerBackgroundColor,handleMachineAction,machine_catalog,setActionState}) {
          ...
          machine_catalog.map((machine) => (
            ...
            <GridListTile key={machine.id} cols={1}>
              ...
              <GridListTileBar
                ...
                actionIcon={
                  <div>
                    <IconButton aria-label={`Informations sur ${machine.type.toUpperCase()}`} className={classes.icon}  onClick={()=>alert('En développement : vous pourrez modifier cette machine')}>
                      <InfoIcon/>
                    </IconButton>
